...
----------------------------------------*/
class rental_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('rental_instagram_photo',esc_html__('[ Rental ] Intagram Photo','rental'),array(
			'description' => esc_html__('Rental Instagram Photo Widget','rental'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'rental');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'rental'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'rental'); ?></label>
...
if(!function_exists('rental_instagram_widgets')):
	function rental_instagram_widgets(){
		register_widget('rental_instagram_photo');
	}
	add_action('widgets_init','rental_instagram_widgets');
endif;
