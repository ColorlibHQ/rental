...
class Rental_social_links extends WP_Widget {
    ...
    function __construct() {
        ...
        esc_html__( '[ Rental ] Social Links', 'rental' ),

        // Widget description
        array( 'description' => esc_html__( 'Add footer social links.', 'rental' ), )
        );
    ...
    public function form( $instance ) {
        ...
        $title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : esc_html__( 'Follow Us', 'rental' );
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'facebook' ) ); ?>"><?php esc_html_e( 'Facebook URL:' ,'rental'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'twitter' ) ); ?>"><?php esc_html_e( 'Twitter URL:' ,'rental'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'linkedin' ) ); ?>"><?php esc_html_e( 'Linkedin URL:' ,'rental'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'behance' ) ); ?>"><?php esc_html_e( 'Behance URL:' ,'rental'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'dribbble' ) ); ?>"><?php esc_html_e( 'Dribbble URL:' ,'rental'); ?></label>
...
} // Class rental_social_links ends here


// Register and load the widget
function rental_social_links_widget_load() {
	register_widget( 'Rental_social_links' );
}
add_action( 'widgets_init', 'rental_social_links_widget_load' );