(function( $ , api){
    ...
    api.section( 'rental_fof_section' , function( section ){
    ...
    // Customizer about page redirect
    api.section( 'rental_about_section' , function( section ){
    ...
    api.section( 'rental_blog_section' , function( section ){
    ...
    api.section( 'rental_contact_section' , function( section ){

        section.expanded.bind( function( isExpanded ){

            // Customizer contact form seclector 
            var customshortcodefield = $('#customize-control-rental_contact_custom_formshortcode'),
                selector = $('#_customize-input-rental_contact_formshortcode');
    ...
    // General section
    api.section( 'rental_general_section' , function( section ){
        ...
        section.expanded.bind( function( isExpanded ){
            ...
            var $preloader      = $('#rental_preloader_toggle'),
                $preloaderbg    = $( '#customize-control-rental_preloader_bg_color' ),
                $preloadercolor = $( '#customize-control-rental_preloader_color' );
            ...
            var $backtotop          = $( '#rental_backtotop_btn' ),
                $backtotopbg        = $( '#customize-control-rental_backtotop_btn_bg_color' ),
                $backtotophoverbg   = $( '#customize-control-rental_backtotop_btn_hover_bg_color' );
    ...
    // Footer section
    api.section( 'rental_footer_section' , function( section ){
        ...
        section.expanded.bind( function( isExpanded ){
            ...
            var $widget_toggle      = $('#rental_footer_widget_toggle');
