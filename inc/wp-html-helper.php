...
// image default alt
if( !function_exists( 'rental_img_default_alt' ) ){
	function rental_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'rental_img_tag' ) ){
	function rental_img_tag( array $args ){
		...
		if( !empty( $args['alt'] ) ){
			...
			$alt = rental_img_default_alt( $url );
		}
...
// Anchor Tag
if( !function_exists( 'rental_anchor_tag' ) ){
	function rental_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'rental_heading_tag' ) ){
	function rental_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'rental_paragraph_tag' ) ){
	function rental_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'rental_other_tag' ) ){
	function rental_other_tag( array $args ){
...
// Button Element 
if( !function_exists( 'rental_button_element ' ) ){
	function rental_button_element( array $args ){
